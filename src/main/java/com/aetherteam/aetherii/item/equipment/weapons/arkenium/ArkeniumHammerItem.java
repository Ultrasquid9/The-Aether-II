...
public class ArkeniumHammerItem extends TieredHammerItem {
    public ArkeniumHammerItem() {
        super(new Properties().attributes(AetherIIDamageStats.merge(TieredHammerItem.createAttributes(AetherIIItemTiers.ARKENIUM, 3, -2.4F), AetherIIDamageStats.ARKENIUM_HAMMER)));
    }
}
