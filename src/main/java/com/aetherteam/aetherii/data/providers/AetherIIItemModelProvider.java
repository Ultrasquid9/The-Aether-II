...
public class AetherIIItemModelProvider extends ModelProvider {
    ...
    public void generateReinforcedItem(ItemModelGenerators itemModels, Item item, ModelTemplate template) {
        ItemModel.Unbaked base = ItemModelUtils.plainModel(itemModels.createFlatItemModel(item, template));
    ...
    public void generateCrossbow(ItemModelGenerators itemModels, Item item) {
        ItemModel.Unbaked base = ItemModelUtils.plainModel(itemModels.createFlatItemModel(item, ModelTemplates.CROSSBOW));
        ...
        ItemModel.Unbaked arrow = ItemModelUtils.plainModel(itemModels.createFlatItemModel(item, "_bolt", ModelTemplates.CROSSBOW));
    ...
    public void generateMoaFeatherItem(ItemModelGenerators itemModels, Item item) {
        ...
        for (Moa.FeatherColor featherColor : Moa.FeatherColor.values()) {
            ...
            ModelTemplates.FLAT_ITEM.create(name, TextureMapping.layer0(name), itemModels.modelOutput);
    ...
    public void generateHealingStoneItem(ItemModelGenerators itemModels, Item item) {
        ItemModel.Unbaked base = ItemModelUtils.plainModel(itemModels.createFlatItemModel(item, "_0", ModelTemplates.FLAT_HANDHELD_ITEM));
        ...
        itemModels.itemModelOutput.accept(item, ItemModelUtils.rangeSelect(new HealingStoneChargeRange(), base,
