...
public class AetherIIRenderers {
    ...
    public static void registerBakedModels(ModelEvent.ModifyBakingResult event) {
        ...
        List<DeferredBlock<? extends Block>> aoBlocks = List.of(AetherIIBlocks.AMBROSIUM_ORE, AetherIIBlocks.UNDERSHALE_AMBROSIUM_ORE, AetherIIBlocks.GLOWING_LAKE_GRASS, AetherIIBlocks.GLOWING_LAKE_GRASS_PLANT);
